let mapOffsetY = 0, // Внутренний отступ карты от холста (top).
	...
	winMouseX = 0, // Курсор по оси X (windows).
	winMouseY = 0, // Курсор по оси Y (windows).
	typeIcon = "map", // Текущий тип обьекта при наведении.
	pageY = 0, //   Курсор по оси X (холста с учетом зумма и отступа).
	pageX = 0, //   Курсор по оси Y (холста с учетом зумма и отступа).
	pageMY = 0, //   Курсор по оси X (холста).
	pageMX = 0, //   Курсор по оси Y (холста).
